    ...
    <div id="top" className="overflow-x-hidden">
      ...
      <main className="pt-32 pb-20 sm:pt-40 sm:pb-28">
          ...
          <Reveal>
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-4xl font-semibold leading-[1.05] sm:text-6xl font-display">
                Making the Digital Journey <br />
                <span className="text-gradient-brand leading-tight">Visible, Intelligent</span> & Better.
              </h1>
              <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                HubTwinX was built to bring unprecedented clarity to how your site operates, performs, and is used. We combine digital twin technology with intelligence to create a connected digital view of the entire facility — from energy and assets to spaces and equipment.
              </p>
              <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                Our focus is simple: help operations become easier to understand, analyze, automate, and improve.
              </p>
            </div>
          </Reveal>
        </section>
          ...
          <Reveal delay={100}>
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="surface-panel p-8 sm:p-10 rounded-2xl border border-border shadow-2xl relative group overflow-hidden">
                ...
                <h3 className="font-display text-2xl font-semibold text-foreground relative">Our Vision</h3>
                <p className="text-muted-foreground mt-4 leading-relaxed text-sm relative">
                  A world where understanding your building or facility is as effortless as understanding a connected smart home. We envision a future where site operations are entirely data-driven, creating spaces that are intelligent, highly efficient, and intuitive to manage.
                </p>
              </div>
              ...
              <div className="surface-panel p-8 sm:p-10 rounded-2xl border border-border shadow-2xl relative group overflow-hidden">
                ...
                <h3 className="font-display text-2xl font-semibold text-foreground relative">Our Mission</h3>
                <p className="text-muted-foreground mt-4 leading-relaxed text-sm relative">
                  To make the invisible physical environment visible and intelligent. We exist to provide the most cohesive and connected digital twin platform—equipping organizations with the insights necessary to optimize performance, reduce waste, and manage easily.
                </p>
              </div>
            </div>
          </Reveal>
        ...
        <section className="px-5 lg:px-8 max-w-5xl mx-auto mt-28">
          <Reveal>
            <div className="mb-10 text-center sm:text-left">
              <p className="eyebrow uppercase">Leadership</p>
              <h2 className="mt-3 text-3xl font-semibold font-display">Guiding Our Vision</h2>
            </div>
            <div className="grid gap-6 sm:grid-cols-2 lg:gap-10">
              {[
                {
                  name: "Er Dr Niraj Shah",
                  role: "Director of HubTwinX",
                  desc: "Automation & Robotics Engineer · Academician, Mentor",
                ...
                },
                {
                  name: "Sudip Mehta",
                  role: "Director of HubTwinX",
                  desc: "Computer Wizard · Entrepreneur & Analyst",
        ...
        <section className="px-5 lg:px-8 max-w-7xl mx-auto mt-28">
          <Reveal>
            <div className="mb-10 text-center sm:text-left">
              <p className="eyebrow uppercase">Tech Team</p>
              <h2 className="mt-3 text-3xl font-semibold font-display">The Technology Team Behind the Platform</h2>
            </div>
